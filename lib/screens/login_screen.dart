import 'package:smarthomedevices_app/screens/signup_screen.dart';
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Future<void> _login() async {
    ...
    try {
      ...
      // 7. Show the error message in a SnackBar
      ...
      // 8. Catch any other general errors
      print(e);
    ...
    // 10. ALWAYS set loading to false at the end
